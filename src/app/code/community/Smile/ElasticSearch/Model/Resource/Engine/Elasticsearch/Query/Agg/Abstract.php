 ...
 */
abstract class Smile_ElasticSearch_Model_Resource_Engine_Elasticsearch_Query_Agg_Abstract
{
    /**
     * Loaded response;
     *
     ...
     *
     * @param array $options Agg options.
     */
     ...
     *
     * @return Smile_ElasticSearch_Model_Resource_Engine_Elasticsearch_Query_Agg_Abstract
     */
     ...
     * @return array
     */
    abstract protected function _getAggQuery();
